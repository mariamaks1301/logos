        ...
        <section className='addProduct'>
            <div className="container">
                <div className="addProduct__content">
                    <form className='form' noValidate  onSubmit={handleSubmit(handleAddProduct)}>
                        ...
                        <label className='form__label'>
                            ...
                            <input {...register('image', {
                                required: true,
                            })} placeholder='Добавьте ссылку на картинку' className='form__field' type="text" />
                        </label>
                        <label className='form__label'>
                        ...
                        <span className='form__lable-title'>Категория</span>
